...
Revision ID: 36d167450ae7
Revises: 8a849dd69c0a
Create Date: 2026-03-09 18:37:39.126574
...
revision: str = '36d167450ae7'
down_revision: Union[str, Sequence[str], None] = '8a849dd69c0a'
...
def upgrade() -> None:
    ...
    sa.Column('refund_amount_paise', sa.Integer(), nullable=True),
    ...
    sa.Column('provider_booking_id', sa.Integer(), nullable=False),
