...
/* ---- Seats Tab ---- */
const SeatsTab = ({ ssrData, travellers, selectedSeats, setSelectedSeats, hasInbound }) => {
    ...
    if (!segment?.seatOptions)
        return <p className="text-gray-500 text-sm">No seats available for this segment.</p>;
